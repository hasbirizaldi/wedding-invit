...
const Create = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://www.brewokode.site/api/wedd", formData, {
        headers: {
      ...
      await alertSuccess("Undangan Berhasil Disimpan");
      navigate("/");
    } catch (error) {
  ...
  return (
    <div className="bg-gray-200/80 lg:px-4 md:px-1 px-1 lg:py-5 md:py-4 py-3 shadow-ku font-noto">
      <h1 className="text-pink-950 text-2xl md:text-xl text-xl font-bold ml-3 font-one">Buat Undangan</h1>
      <div className="overflow-x-auto">
        <form onSubmit={handleSubmit} className="space-y-2 ">
          <div className="lg:w-[99%] md:w-[99%] w-[98%] ml-1 lg:ml-1 md:ml-1 mb-2 mt-2 lg:px-5 px-3 py-4 rounded shadow-ku bg-white ">
            <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-3">
              <div>
                ...
                <select
                  ...
                  className={`w-full px-3 py-1.5 border cursor-pointer rounded shadow-sm focus:ring-pink-400 focus:border-pink-400 outline-none text-sm ${errors.theme_id ? "border-red-500" : "border-gray-300"}`}
                >
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-2">
            <div className="bg-white w-[99%] lg:px-6 px-3 pt-6 pb-8 rounded shadow-ku mx-auto ">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className={`w-full px-3 py-1.5 border border-gray-300 rounded-md shadow-sm focus:ring-pink-400 focus:border-pink-400  outline-none text-sm ${errors.fullname_imp ? "border-red-500" : "border-gray-300"}`}
                />
                {errors.fullname_imp && <span className="text-red-500 text-xs">{errors.fullname_imp}</span>}
              </div>
            </div>
            <div className="bg-white w-[99%] px-3 lg:px-6 pt-6 pb-8 rounded shadow-ku mx-auto">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-2">
            <div className="bg-white w-[99%] px-3 lg:px-6 pt-6 pb-8 rounded shadow-ku mx-auto">
              ...
              <div className="mb-3">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Link Google Map Venue Resepsi <span className="text-red-600 text-[14px]"></span>
                </label>
                <input
                  type="text"
            ...
            <div className="bg-white w-[99%] px-6 pt-6 pb-8 rounded shadow-ku mx-auto">
          ...
          {/* Gallery & Gift */}
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-2">
            <div className="bg-white w-[99%] px-3 lg:px-6 pt-6 pb-8 rounded-2xl shadow-ku mx-auto">
              <h1 className="text-pink-950 text-base font-bold font-one">Gallery</h1>
              <div className="bg-gray-950/40 h-[2px] rounded-4xl w-full mb-3"></div>
              <div className="mb-3">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Foto mempelai Pria <span className="text-[11px] text-gray-700">(Format jpg, jpeg, png, webp, max 1MB)</span>
                </label>
                <input type="file" name="foto_mp" onChange={handleFileChange} className={`w-full px-3 py-1.5 border border-gray-300 rounded shadow-sm focus:ring-pink-400 focus:border-pink-400  outline-none text-sm cursor-pointer`} />
              ...
              <div className="mb-3">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Foto mempelai Wanita <span className="text-[11px] text-gray-700">(Format jpg, jpeg, png, webp, max 1MB)</span>
                </label>
                <input type="file" name="foto_mw" onChange={handleFileChange} className="w-full px-3 py-1.5 border border-gray-300 rounded shadow-sm focus:ring-pink-400 focus:border-pink-400  outline-none text-sm cursor-pointer" />
              ...
              <div className="mb-3">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Gallery Foto <span className="text-[11px] text-gray-700">(Format jpg, jpeg, png, webp, max 2MB)</span>
                </label>
                <input
                  type="file"
                  name="galleries"
                  onChange={handleFileChange}
                  className="w-full px-3 py-1.5 border border-gray-300 rounded shadow-sm focus:ring-pink-400 focus:border-pink-400  outline-none text-sm cursor-pointer"
                  multiple
                />
            ...
            <div className="bg-white w-[99%] px-6 pt-6 pb-8 rounded-2xl shadow-ku mx-auto">
              {/* Gift */}
